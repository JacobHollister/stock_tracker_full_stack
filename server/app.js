...
const stockTrades = require('./routes/stockTradesRoutes')
const cryptoTrades = require('./routes/cryptoTradesRoutes')
...
app.use('/api/v1/trades/stock', stockTrades)
app.use('/api/v1/trades/crypto', cryptoTrades)
